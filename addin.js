...
setSave(0);
const comp=[['Years in Business','25+ Years (Since 2002)','~10 Years','~10 Years','~20 Years'],['Platform Options','Geotab + ZenduONE + LytxONE','Single','Single','Limited'],['Hardware Included','All Bundled Plans','Separate','Separate','Varies'],['Dedicated Support','Direct Expert Access','Scaled','Scaled','Tiered'],['Professional Install','Full Install Service','Self-Install','Self-Install','Extra Fee'],['Camera Options','GO Focus + ZenCAM + LytxONE','Yes','Yes','Limited']];
